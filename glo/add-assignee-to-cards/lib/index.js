    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (let i = 0; i < cards.length; i++) {
                ...
                const board = yield glo_sdk_1.default(authToken).boards.get(boardId, { fields: ['members'] });
                if (!board) {
                ...
                const card = yield glo_sdk_1.default(authToken).boards.cards.get(boardId, cardId, { fields: ['assignees'] });
                if (!card) {
